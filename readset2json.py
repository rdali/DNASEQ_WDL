...
def help():
        ...
        usage: readset2json.py -r myReadsetFile -o myJsonOutput
...
def reads_to_dict(file_path):
	try:
		...
		#print(wf_samples)
		return {"wf.samples" : list(wf_samples.values())}
...
if __name__ == "__main__":
	...
	readsetFile = outputFile = None

	try:
	    options,remainder = getopt.getopt(sys.argv[1:],'r:o:h',["readsetFile=","outputFile=","help"])
